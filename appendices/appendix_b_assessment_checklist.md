...
| Requirement | Status | Notes / Evidence / Gaps |
|-------------|--------|-------------------------|
| Defined roles and responsibilities | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Formal review workflow | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Documentation of review activities | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Testing oversight effectiveness | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Escalation protocols | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Integration with systems | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |

### CTI-AI-4: Model Risk Assessment and Validation

| Requirement | Status | Notes / Evidence / Gaps |
|-------------|--------|-------------------------|
| Formal risk assessment framework | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Pre-deployment validation process | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Hallucination rate testing | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Supply chain risk assessment | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Continuous monitoring | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Threshold-based restrictions | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |

### CTI-AI-5: Data Integrity Controls

| Requirement | Status | Notes / Evidence / Gaps |
|-------------|--------|-------------------------|
| Input validation procedures | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Provenance tracking | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Source verification | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Documentation of data sources | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Data poisoning prevention | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Validation testing | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |

### CTI-AI-6: Red Teaming and Model Evaluation

| Requirement | Status | Notes / Evidence / Gaps |
|-------------|--------|-------------------------|
| Dedicated red team capability | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Regular adversarial testing | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Documentation of test scenarios | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Testing in development phase | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| External evaluator engagement | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
| Remediation of identified issues | ☐ Implemented<br>☐ Partially<br>☐ Not Implemented | |
